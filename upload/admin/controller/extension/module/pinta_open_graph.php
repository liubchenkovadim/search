        ...
        if($this->request->files["pinta_open_graph_image_default"]['error'] == 0) {
            ...
            if ($f_type == "image/gif" OR $f_type == "image/png" OR $f_type == "image/jpeg" OR $f_type == "image/JPEG" OR $f_type == "image/PNG" OR $f_type == "image/GIF") {
                ...
                elseif (is_uploaded_file($this->request->files["pinta_open_graph_image_default"]["tmp_name"])) {
                    ...
                    move_uploaded_file($this->request->files["pinta_open_graph_image_default"]["tmp_name"], DIR_IMAGE . $this->request->files["pinta_open_graph_image_default"]["name"]);
                    $this->request->post['pinta_open_graph_image_default'] = HTTPS_CATALOG . 'image/' . $this->request->files["pinta_open_graph_image_default"]["name"];
                } else {
