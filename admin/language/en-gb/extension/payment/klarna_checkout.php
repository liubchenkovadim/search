...
$_['help_locale']						 = 'Locale code for each account. Two-letter language code combined with two-letter country code according to RFC 1766. (e.g. english for British English or sv-se for Swedish)';
