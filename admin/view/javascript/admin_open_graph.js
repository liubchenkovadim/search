$(document).ready(function () {
    ...
    $('a.add_time').on('click',function (event) {
        ...
        $('tr.time-tr:last').after( '<tr class="time-tr"><td></td><td><input type="text" class="form-control" name="pinta_schema_org_select_time_full['+index+'][day]" ></td><td></td><td><input type="text" class="form-control" name="pinta_schema_org_select_time_full['+index+'][time]" ></td></tr>');
    });
